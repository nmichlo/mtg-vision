...
export const $stats = atom<Stats>({
  messagesSent: 0,
  messagesReceived: 0,
  serverProcessTime: null,
  serverProcessPeriod: null,
  serverRecvImBytes: null,
  serverSendImBytes: null,
});
export const $videoDimensions = atom<{ width: number; height: number } | null>(
  null,
);
